...
import { deprecate } from "../utils/assert.js";
import type * as ASTv1 from "../v1/api";
import visitorKeys, {
  type VisitorKey,
  type VisitorKeys,
} from "../v1/visitor-keys";
import {
  cannotRemoveNode,
  cannotReplaceNode,
...
function set<N extends ASTv1.Node, K extends keyof N>(
  node: N,
  key: K,
  value: N[K]
): void {
...
function spliceArray(
  array: ASTv1.Node[],
  index: number,
  result: ASTv1.Node | ASTv1.Node[] | null
) {
  if (result === null) {
