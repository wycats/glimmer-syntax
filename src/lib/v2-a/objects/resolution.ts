...
import {
  ...
  GET_FREE_AS_COMPONENT_HEAD,
  GET_FREE_AS_COMPONENT_OR_HELPER_HEAD_OR_THIS_FALLBACK,
  GET_FREE_AS_HELPER_HEAD,
  GET_FREE_AS_MODIFIER_HEAD,
  GET_STRICT_FREE,
} from '../../wire.js';
  ...
  switch (resolution[0]) {
    case 'ambiguous':
      switch (resolution[1]) {
        ...
        default:
          exhaustive(resolution[1], 'resolution[1]');
      }
